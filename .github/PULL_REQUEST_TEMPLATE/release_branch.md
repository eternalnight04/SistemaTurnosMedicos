# 📦 [GRUPO N°4][Actividad Obligatoria N°1] Entrega Final - Release a master
...
|-----------------|-------------------------------|----------------|
| Santiago Ferreyra | Modelador | @ferreyrasantiagojoaquin-lab |
| Tomás Torres | Modelador (co) | @TomasTorres27 |
| Natalia Carreras | Documentadora y Coordinadora + Diseñadora | @nataliacarreras96git |

---

## 📂 Archivos y entregables principales incluidos

- `anexos/introduccion.md`: Requisitos (RF1-RF9, RNF1-RNF5), 5 Casos de Uso (CU-01 a CU-05) y fundamentos POO.
- `diagramas/01-diagrama-clases/`: Diagrama UML inicial de clases (01-boceto-inicial.excalidraw y 01-boceto-inicial.png).
- `README.md`: Descripción general del proyecto y equipo.
- `anexos/anexos.md`: Recursos complementarios y referencias.
- `changelog.md`: Registro completo de contribuciones y PRs mergeadas.
