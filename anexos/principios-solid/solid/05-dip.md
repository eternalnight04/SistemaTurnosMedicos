...
## 3. Análisis de dependencias actuales entre clases
Turno:
...
La inyección de dependencias es un patrón de diseño que consiste en proveer a un objeto sus dependencias (otras clases o servicios que necesita) desde el exterior, en vez de crearlas dentro de la propia clase. Esto facilita el testeo, la flexibilidad y el desacoplamiento.

Ejemplo aplicado al sistema de turnos médicos
...
## 7. Diagrama de clases UML después de aplicar DIP
