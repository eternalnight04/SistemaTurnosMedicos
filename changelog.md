...
- [feature/modelador-casos-uso] Documentación de 5 Casos de Uso (UC-01 a UC-05) a partir de fuentes de dominio. PR: [#6](https://github.com/nataliacarreras96git/SistemaTurnosMedicos/pull/6) — @ademarco97 (Modelador)
...
- [feature/normalizacion-nombres] Renombrado de carpetas a minúsculas. PR: [#11](https://github.com/nataliacarreras96git/SistemaTurnosMedicos/pull/11) — @nataliacarreras96git (Documentadora)
